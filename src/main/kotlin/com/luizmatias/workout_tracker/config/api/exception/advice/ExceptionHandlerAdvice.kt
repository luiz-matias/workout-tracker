package com.luizmatias.workout_tracker.config.api.exception.advice

import com.luizmatias.workout_tracker.config.api.exception.common_exceptions.InternalServerErrorException
import com.luizmatias.workout_tracker.config.api.exception.common_exceptions.MalformedDataException
...
class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler(com.luizmatias.workout_tracker.config.api.exception.common_exceptions.BusinessRuleConflictException::class)
    fun handleBusinessRuleConflictException(
        exception: com.luizmatias.workout_tracker.config.api.exception.common_exceptions.BusinessRuleConflictException,
        request: HttpServletRequest
    ): ErrorResponseDTO {
        return ErrorResponseDTO(
    ...
    @ExceptionHandler(com.luizmatias.workout_tracker.config.api.exception.common_exceptions.ForbiddenException::class)
    fun handleForbiddenException(
        exception: com.luizmatias.workout_tracker.config.api.exception.common_exceptions.ForbiddenException,
        request: HttpServletRequest
    ): ErrorResponseDTO {
        return ErrorResponseDTO(
